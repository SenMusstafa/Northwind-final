...
public class OrderManager implements OrderService {
    ...
    public Result add(CreateOrderRequest createOrderRequest) {
        checkOrderAlredyExists(createOrderRequest.getOrderId());
    ...
    private void checkOrderExists(int orderId) {
        if (!orderRepository.existsById(orderId)){
            throw new BusinessException("OrderId does not exist.");
        }
    }
    private void checkOrderAlredyExists(int orderId) {
        if (orderRepository.existsById(orderId)){
            throw new BusinessException("OrderId already not exist.");
        }
    }
}
